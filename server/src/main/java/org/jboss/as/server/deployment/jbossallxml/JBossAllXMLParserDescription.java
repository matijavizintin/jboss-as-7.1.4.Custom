...
class JBossAllXMLParserDescription<T> {
     ...
     */
    public static final AttachmentKey<AttachmentList<JBossAllXMLParserDescription<?>>>
            ATTACHMENT_KEY = AttachmentKey.createList(JBossAllXMLParserDescription.class);
