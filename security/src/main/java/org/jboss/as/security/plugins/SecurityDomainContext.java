...
public class SecurityDomainContext {
    ...
    static final String CERT_MAPPING = "certMapping";
    ...
    CertificatePrincipal certMapping = new SubjectDNMapping();
    ...
    public Object lookup(String name) throws NamingException {
        ...
        else if (name.equals(CERT_MAPPING))
            binding = getCertMapping();
    ...
    public CertificatePrincipal getCertMapping() {
        return certMapping;
    }

    public void setCertMapping(CertificatePrincipal certMapping) {
