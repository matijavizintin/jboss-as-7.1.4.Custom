...
public class SecurityDomainService implements Service<SecurityDomainContext> {
    ...
    private final JBossCertificateMappingSecurityManager certMappingSecurityManager;

    private volatile SecurityDomainContext securityDomainContext;

    private final String cacheType;

    public SecurityDomainService(String name, ApplicationPolicy applicationPolicy, JSSESecurityDomain jsseSecurityDomain, JBossCertificateMappingSecurityManager certMappingSecurityManager,
            String cacheType) {
        this.name = name;
        this.applicationPolicy = applicationPolicy;
        this.jsseSecurityDomain = jsseSecurityDomain;
        this.certMappingSecurityManager = certMappingSecurityManager;
    ...
    public void start(StartContext context) throws StartException {
        ...
        if (certMappingSecurityManager != null) {
            try {
                certMappingSecurityManager.processCertificateMapping();
                securityDomainContext.setCertMapping(certMappingSecurityManager.getCertificatePrincipalMapping());
            } catch (Exception e) {
                throw SecurityMessages.MESSAGES.unableToStartException("SecurityDomainService", e);
            }
        }
