...
public interface ModulesMap {
    ...
    Map<String, String> CERT_MAPPING_MAP = Collections.unmodifiableMap(new HashMap<String, String>() {

        private static final long serialVersionUID = 1210873488987888574L;

        {
            put("SubjectDN", SubjectDNMapping.class.getName());
            put("SubjectCN", SubjectCNMapping.class.getName());
            put("SerialNumberIssuerDN", SerialNumberIssuerDNMapping.class.getName());
            put("SubjectX500Principal", SubjectX500Principal.class.getName());
        }
    });
